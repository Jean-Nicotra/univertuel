 ...
 */
final class Version20220527071338 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE relation (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, relation_id INT NOT NULL, comment LONGTEXT DEFAULT NULL, INDEX IDX_62894749A76ED395 (user_id), INDEX IDX_628947493256915B (relation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE relation ADD CONSTRAINT FK_62894749A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE relation ADD CONSTRAINT FK_628947493256915B FOREIGN KEY (relation_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_relations (user_id INT NOT NULL, relation INT NOT NULL, INDEX IDX_148C329C62894749 (relation), INDEX IDX_148C329CA76ED395 (user_id), PRIMARY KEY(user_id, relation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE user_relations ADD CONSTRAINT FK_148C329C62894749 FOREIGN KEY (relation) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
