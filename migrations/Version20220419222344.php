 ...
 */
final class Version20220419222344 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE figures_weapons (figure_id INT NOT NULL, weapon_id INT NOT NULL, INDEX IDX_413F969E5C011B5 (figure_id), INDEX IDX_413F969E95B82273 (weapon_id), PRIMARY KEY(figure_id, weapon_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE prophecy_figure_currency (id INT AUTO_INCREMENT NOT NULL, figure_id INT NOT NULL, currency_id INT NOT NULL, value INT NOT NULL, INDEX IDX_4DF1D5D85C011B5 (figure_id), INDEX IDX_4DF1D5D838248176 (currency_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE figures_weapons ADD CONSTRAINT FK_413F969E5C011B5 FOREIGN KEY (figure_id) REFERENCES prophecy_figure (id)');
        $this->addSql('ALTER TABLE figures_weapons ADD CONSTRAINT FK_413F969E95B82273 FOREIGN KEY (weapon_id) REFERENCES prophecy_weapon (id)');
