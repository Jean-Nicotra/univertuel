 ...
 */
final class Version20220822184656 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure ADD is_initial_currencies_generated TINYINT(1) DEFAULT NULL');
    }
