 ...
 */
final class Version20220415093049 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure ADD mana INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure DROP mana, CHANGE name name VARCHAR(120) NOT NULL COLLATE `utf8mb4_unicode_ci`');
