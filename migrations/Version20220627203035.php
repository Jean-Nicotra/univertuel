 ...
 */
final class Version20220627203035 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_age_disadvantage ADD campaign_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE prophecy_age_disadvantage ADD CONSTRAINT FK_D35FC1DCF639F774 FOREIGN KEY (campaign_id) REFERENCES campaign (id)');
        $this->addSql('CREATE INDEX IDX_D35FC1DCF639F774 ON prophecy_age_disadvantage (campaign_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_age_disadvantage DROP FOREIGN KEY FK_D35FC1DCF639F774');
        $this->addSql('DROP INDEX IDX_D35FC1DCF639F774 ON prophecy_age_disadvantage');
        $this->addSql('ALTER TABLE prophecy_age_disadvantage DROP campaign_id');
