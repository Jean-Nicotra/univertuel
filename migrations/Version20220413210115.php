 ...
 */
final class Version20220413210115 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prophecy_figure_major_attribute (id INT AUTO_INCREMENT NOT NULL, figure_id INT NOT NULL, attribute_id INT NOT NULL, value INT NOT NULL, INDEX IDX_7F3920AB5C011B5 (figure_id), INDEX IDX_7F3920ABB6E62EFA (attribute_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE prophecy_figure_major_attribute ADD CONSTRAINT FK_7F3920ABB6E62EFA FOREIGN KEY (attribute_id) REFERENCES prophecy_major_attribute (id)');
        $this->addSql('ALTER TABLE prophecy_figure DROP FOREIGN KEY FK_976724285D20926C');
        $this->addSql('DROP INDEX IDX_976724285D20926C ON prophecy_figure');
        $this->addSql('ALTER TABLE prophecy_figure DROP caracteristics_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure ADD caracteristics_id INT DEFAULT NULL, CHANGE name name VARCHAR(120) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE prophecy_figure ADD CONSTRAINT FK_976724285D20926C FOREIGN KEY (caracteristics_id) REFERENCES prophecy_figure_caracteristic (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE INDEX IDX_976724285D20926C ON prophecy_figure (caracteristics_id)');
