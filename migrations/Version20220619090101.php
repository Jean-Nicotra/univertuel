 ...
 */
final class Version20220619090101 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure ADD is_tendencies_choosen TINYINT(1) NOT NULL');
    }
