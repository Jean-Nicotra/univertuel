 ...
 */
final class Version20220911095312 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prophecy_skill_cost (id INT AUTO_INCREMENT NOT NULL, campaign_id INT NOT NULL, score INT DEFAULT NULL, value INT DEFAULT NULL, INDEX IDX_DCC36C5FF639F774 (campaign_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE prophecy_skill_cost ADD CONSTRAINT FK_DCC36C5FF639F774 FOREIGN KEY (campaign_id) REFERENCES campaign (id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE prophecy_skill_cost');
