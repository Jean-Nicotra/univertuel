 ...
 */
final class Version20220413140639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_caracteristic CHANGE caracteristic_id caracteristic_id INT NOT NULL, CHANGE value value INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_caracteristic CHANGE caracteristic_id caracteristic_id INT DEFAULT NULL, CHANGE value value INT NOT NULL');
