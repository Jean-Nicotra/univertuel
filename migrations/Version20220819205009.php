 ...
 */
final class Version20220819205009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prophecy_initial_currencies (id INT AUTO_INCREMENT NOT NULL, caste_id INT NOT NULL, currency_id INT NOT NULL, dices INT NOT NULL, INDEX IDX_7A95193B29B1D13 (caste_id), INDEX IDX_7A95193B38248176 (currency_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE roll (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE prophecy_initial_currencies ADD CONSTRAINT FK_7A95193B29B1D13 FOREIGN KEY (caste_id) REFERENCES prophecy_caste (id)');
        $this->addSql('ALTER TABLE prophecy_initial_currencies ADD CONSTRAINT FK_7A95193B38248176 FOREIGN KEY (currency_id) REFERENCES prophecy_currency (id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE prophecy_initial_currencies');
