 ...
 */
final class Version20220415095356 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure ADD nation_id INT DEFAULT NULL, ADD weight VARCHAR(255) DEFAULT NULL, ADD size VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_97672428AE3899 ON prophecy_figure (nation_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_97672428AE3899 ON prophecy_figure');
        $this->addSql('ALTER TABLE prophecy_figure DROP nation_id, DROP weight, DROP size, CHANGE name name VARCHAR(120) NOT NULL COLLATE `utf8mb4_unicode_ci`');
