 ...
 */
final class Version20220414204026 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_discipline CHANGE value value INT DEFAULT NULL, CHANGE mana mana INT DEFAULT NULL, CHANGE current_mana current_mana INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_discipline CHANGE value value INT NOT NULL, CHANGE mana mana INT NOT NULL, CHANGE current_mana current_mana INT NOT NULL');
