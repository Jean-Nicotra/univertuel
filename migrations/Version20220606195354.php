 ...
 */
final class Version20220606195354 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure ADD is_major_attributes_initialised TINYINT(1) NOT NULL');
    }
