 ...
 */
final class Version20220717100214 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_prohibited ADD figure_id INT NOT NULL, ADD prohibited_id INT NOT NULL, DROP figure, DROP prohibited');
        $this->addSql('ALTER TABLE prophecy_figure_prohibited ADD CONSTRAINT FK_F56BE2F45C011B5 FOREIGN KEY (figure_id) REFERENCES prophecy_figure (id)');
        $this->addSql('ALTER TABLE prophecy_figure_prohibited ADD CONSTRAINT FK_F56BE2F4ECE85184 FOREIGN KEY (prohibited_id) REFERENCES prophecy_prohibited (id)');
        $this->addSql('CREATE INDEX IDX_F56BE2F45C011B5 ON prophecy_figure_prohibited (figure_id)');
        $this->addSql('CREATE INDEX IDX_F56BE2F4ECE85184 ON prophecy_figure_prohibited (prohibited_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_prohibited DROP FOREIGN KEY FK_F56BE2F45C011B5');
        $this->addSql('ALTER TABLE prophecy_figure_prohibited DROP FOREIGN KEY FK_F56BE2F4ECE85184');
        $this->addSql('DROP INDEX IDX_F56BE2F45C011B5 ON prophecy_figure_prohibited');
        $this->addSql('DROP INDEX IDX_F56BE2F4ECE85184 ON prophecy_figure_prohibited');
        $this->addSql('ALTER TABLE prophecy_figure_prohibited ADD figure INT NOT NULL, ADD prohibited INT NOT NULL, DROP figure_id, DROP prohibited_id, CHANGE comment comment VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
