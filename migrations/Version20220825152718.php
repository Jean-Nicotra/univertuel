 ...
 */
final class Version20220825152718 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prophecy_figure_armor (id INT AUTO_INCREMENT NOT NULL, figure_id INT NOT NULL, armor_id INT NOT NULL, comment VARCHAR(255) DEFAULT NULL, INDEX IDX_B40C7D305C011B5 (figure_id), INDEX IDX_B40C7D30F5AA3663 (armor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE prophecy_figure_armor ADD CONSTRAINT FK_B40C7D305C011B5 FOREIGN KEY (figure_id) REFERENCES prophecy_figure (id)');
        $this->addSql('ALTER TABLE prophecy_figure_armor ADD CONSTRAINT FK_B40C7D30F5AA3663 FOREIGN KEY (armor_id) REFERENCES prophecy_armor (id)');
        $this->addSql('ALTER TABLE prophecy_figure_weapon DROP quantity');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE prophecy_figure_armor');
        ...
        $this->addSql('ALTER TABLE prophecy_figure_weapon ADD quantity INT NOT NULL, CHANGE comment comment VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
