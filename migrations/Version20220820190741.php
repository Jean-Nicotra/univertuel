 ...
 */
final class Version20220820190741 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_initial_currencies CHANGE campaign_id campaign_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_initial_currencies CHANGE campaign_id campaign_id INT NOT NULL');
