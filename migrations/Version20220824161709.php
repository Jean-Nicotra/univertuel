 ...
 */
final class Version20220824161709 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_favour DROP FOREIGN KEY FK_B87858FFCA2F0FB1');
        $this->addSql('ALTER TABLE prophecy_figure_favour ADD CONSTRAINT FK_B87858FFCA2F0FB1 FOREIGN KEY (favour_id) REFERENCES prophecy_favour (id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE prophecy_figures_favours (figure_id INT NOT NULL, favour_id INT NOT NULL, INDEX IDX_1160D4005C011B5 (figure_id), INDEX IDX_1160D400CA2F0FB1 (favour_id), PRIMARY KEY(figure_id, favour_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE prophecy_figures_favours ADD CONSTRAINT FK_1160D4005C011B5 FOREIGN KEY (figure_id) REFERENCES prophecy_figure (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE prophecy_figures_favours ADD CONSTRAINT FK_1160D400CA2F0FB1 FOREIGN KEY (favour_id) REFERENCES prophecy_favour (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('ALTER TABLE prophecy_figure_favour ADD CONSTRAINT FK_B87858FFCA2F0FB1 FOREIGN KEY (favour_id) REFERENCES prophecy_discipline (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
