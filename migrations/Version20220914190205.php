 ...
 */
final class Version20220914190205 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_skill_cost CHANGE campaign_id campaign_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_skill_cost CHANGE campaign_id campaign_id INT NOT NULL');
