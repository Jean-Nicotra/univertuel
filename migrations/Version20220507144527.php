 ...
 */
final class Version20220507144527 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prophecy_figure (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, campaign_id INT NOT NULL, caste_id INT DEFAULT NULL, omen_id INT DEFAULT NULL, age_id INT DEFAULT NULL, nation_id INT DEFAULT NULL, name VARCHAR(120) NOT NULL, mana INT DEFAULT NULL, reputation INT DEFAULT NULL, current_mana INT DEFAULT NULL, weight VARCHAR(255) DEFAULT NULL, size VARCHAR(255) DEFAULT NULL, xperience INT DEFAULT NULL, background LONGTEXT DEFAULT NULL, is_finish TINYINT(1) NOT NULL, INDEX IDX_976724287E3C61F9 (owner_id), INDEX IDX_97672428F639F774 (campaign_id), INDEX IDX_9767242829B1D13 (caste_id), INDEX IDX_9767242847D39BD9 (omen_id), INDEX IDX_97672428CC80CD12 (age_id), INDEX IDX_97672428AE3899 (nation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
