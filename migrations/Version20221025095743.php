 ...
 */
final class Version20221025095743 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prophecy_wounds (id INT AUTO_INCREMENT NOT NULL, wound_id INT NOT NULL, campaign_id INT DEFAULT NULL, maxsum INT NOT NULL, INDEX IDX_D282D3B5EEE052C4 (wound_id), INDEX IDX_D282D3B5F639F774 (campaign_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE prophecy_wounds ADD CONSTRAINT FK_D282D3B5EEE052C4 FOREIGN KEY (wound_id) REFERENCES prophecy_wound (id)');
        $this->addSql('ALTER TABLE prophecy_wounds ADD CONSTRAINT FK_D282D3B5F639F774 FOREIGN KEY (campaign_id) REFERENCES campaign (id)');
    }
