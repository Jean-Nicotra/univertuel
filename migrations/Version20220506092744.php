 ...
 */
final class Version20220506092744 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure CHANGE omen_id omen_id INT DEFAULT NULL, CHANGE age_id age_id INT DEFAULT NULL');
    }
