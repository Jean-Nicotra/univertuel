 ...
 */
final class Version20220430212053 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_caracteristic CHANGE caracteristic_id caracteristic_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_caracteristic CHANGE caracteristic_id caracteristic_id INT NOT NULL');
