 ...
 */
final class Version20221025135823 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_625E688EEE052C4 ON prophecy_figure_wound');
        $this->addSql('ALTER TABLE prophecy_figure_wound CHANGE wound_id wounds_id INT NOT NULL');
        $this->addSql('ALTER TABLE prophecy_figure_wound ADD CONSTRAINT FK_625E6887B965BDE FOREIGN KEY (wounds_id) REFERENCES prophecy_wounds (id)');
        $this->addSql('CREATE INDEX IDX_625E6887B965BDE ON prophecy_figure_wound (wounds_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_disadvantage CHANGE comment comment VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE prophecy_figure_prohibited CHANGE comment comment VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE prophecy_figure_shield CHANGE comment comment VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE prophecy_figure_wound DROP FOREIGN KEY FK_625E6887B965BDE');
        $this->addSql('DROP INDEX IDX_625E6887B965BDE ON prophecy_figure_wound');
        $this->addSql('ALTER TABLE prophecy_figure_wound CHANGE wounds_id wound_id INT NOT NULL');
        $this->addSql('ALTER TABLE prophecy_figure_wound ADD CONSTRAINT FK_625E688EEE052C4 FOREIGN KEY (wound_id) REFERENCES prophecy_wound (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE INDEX IDX_625E688EEE052C4 ON prophecy_figure_wound (wound_id)');
        ...
        $this->addSql('ALTER TABLE prophecy_wound CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
