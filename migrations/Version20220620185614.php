 ...
 */
final class Version20220620185614 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_disadvantage ADD figure_id INT NOT NULL, ADD disadvantage_id INT NOT NULL, DROP figure, DROP disadvantage');
        $this->addSql('ALTER TABLE prophecy_figure_disadvantage ADD CONSTRAINT FK_5B6838AC5C011B5 FOREIGN KEY (figure_id) REFERENCES prophecy_figure (id)');
        $this->addSql('ALTER TABLE prophecy_figure_disadvantage ADD CONSTRAINT FK_5B6838AC7995CCA1 FOREIGN KEY (disadvantage_id) REFERENCES prophecy_disadvantage (id)');
        $this->addSql('CREATE INDEX IDX_5B6838AC5C011B5 ON prophecy_figure_disadvantage (figure_id)');
        $this->addSql('CREATE INDEX IDX_5B6838AC7995CCA1 ON prophecy_figure_disadvantage (disadvantage_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE prophecy_figures_disadvantages (figure_id INT NOT NULL, disadvantage_id INT NOT NULL, INDEX IDX_C2316975C011B5 (figure_id), INDEX IDX_C2316977995CCA1 (disadvantage_id), PRIMARY KEY(figure_id, disadvantage_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE prophecy_figures_disadvantages ADD CONSTRAINT FK_C2316975C011B5 FOREIGN KEY (figure_id) REFERENCES prophecy_figure (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE prophecy_figures_disadvantages ADD CONSTRAINT FK_C2316977995CCA1 FOREIGN KEY (disadvantage_id) REFERENCES prophecy_disadvantage (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('ALTER TABLE prophecy_figure_disadvantage DROP FOREIGN KEY FK_5B6838AC5C011B5');
        $this->addSql('ALTER TABLE prophecy_figure_disadvantage DROP FOREIGN KEY FK_5B6838AC7995CCA1');
        $this->addSql('DROP INDEX IDX_5B6838AC5C011B5 ON prophecy_figure_disadvantage');
        $this->addSql('DROP INDEX IDX_5B6838AC7995CCA1 ON prophecy_figure_disadvantage');
        $this->addSql('ALTER TABLE prophecy_figure_disadvantage ADD figure INT NOT NULL, ADD disadvantage INT NOT NULL, DROP figure_id, DROP disadvantage_id, CHANGE comment comment VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
