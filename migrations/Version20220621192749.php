 ...
 */
final class Version20220621192749 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_disadvantage DROP comment');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_disadvantage ADD comment VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
