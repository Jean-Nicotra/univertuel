 ...
 */
final class Version20220604015205 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure ADD prohibited_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE prophecy_figure ADD CONSTRAINT FK_97672428ECE85184 FOREIGN KEY (prohibited_id) REFERENCES prophecy_prohibited (id)');
        $this->addSql('CREATE INDEX IDX_97672428ECE85184 ON prophecy_figure (prohibited_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE prophecy_figures_prohibiteds (figure_id INT NOT NULL, prohibited_id INT NOT NULL, INDEX IDX_CFD10BD25C011B5 (figure_id), INDEX IDX_CFD10BD2ECE85184 (prohibited_id), PRIMARY KEY(figure_id, prohibited_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE prophecy_figures_prohibiteds ADD CONSTRAINT FK_CFD10BD25C011B5 FOREIGN KEY (figure_id) REFERENCES prophecy_figure (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE prophecy_figures_prohibiteds ADD CONSTRAINT FK_CFD10BD2ECE85184 FOREIGN KEY (prohibited_id) REFERENCES prophecy_prohibited (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
