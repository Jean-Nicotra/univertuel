 ...
 */
final class Version20220714183051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure ADD is_valide TINYINT(1) NOT NULL');
    }
