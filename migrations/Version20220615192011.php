 ...
 */
final class Version20220615192011 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure ADD is_caracteristics_choosen TINYINT(1) NOT NULL');
    }
