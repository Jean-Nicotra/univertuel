 ...
 */
final class Version20220613201634 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prophecy_tendency_age_nation (id INT AUTO_INCREMENT NOT NULL, nation_id INT NOT NULL, age_id INT NOT NULL, tendency INT NOT NULL, INDEX IDX_B2BEB61CAE3899 (nation_id), INDEX IDX_B2BEB61CCC80CD12 (age_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE prophecy_tendency_age_nation ADD CONSTRAINT FK_B2BEB61CAE3899 FOREIGN KEY (nation_id) REFERENCES prophecy_nation (id)');
        $this->addSql('ALTER TABLE prophecy_tendency_age_nation ADD CONSTRAINT FK_B2BEB61CCC80CD12 FOREIGN KEY (age_id) REFERENCES prophecy_age (id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE prophecy_tendency_age_nation');
