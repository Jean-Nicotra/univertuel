 ...
 */
final class Version20220420203741 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_armor ADD category_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_3215A3CB12469DE2 ON prophecy_armor (category_id)');
    }
