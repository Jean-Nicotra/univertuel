 ...
 */
final class Version20220901201502 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure ADD is_prohibiteds_chosen TINYINT(1) NOT NULL');
    }
