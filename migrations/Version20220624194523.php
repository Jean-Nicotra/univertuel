 ...
 */
final class Version20220624194523 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prophecy_age_disadvantage (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, age_id INT DEFAULT NULL, value INT NOT NULL, is_optional TINYINT(1) NOT NULL, INDEX IDX_D35FC1DC12469DE2 (category_id), INDEX IDX_D35FC1DCCC80CD12 (age_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE prophecy_age_disadvantage ADD CONSTRAINT FK_D35FC1DC12469DE2 FOREIGN KEY (category_id) REFERENCES prophecy_advantage_category (id)');
        $this->addSql('ALTER TABLE prophecy_age_disadvantage ADD CONSTRAINT FK_D35FC1DCCC80CD12 FOREIGN KEY (age_id) REFERENCES prophecy_age (id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE prophecy_age_disadvantage');
