 ...
 */
final class Version20220414130424 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_skill ADD figure_id INT NOT NULL, ADD skill_id INT NOT NULL, DROP figure, DROP skill');
        ...
        $this->addSql('CREATE INDEX IDX_551667BB5C011B5 ON prophecy_figure_skill (figure_id)');
        $this->addSql('CREATE INDEX IDX_551667BB5585C142 ON prophecy_figure_skill (skill_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_551667BB5C011B5 ON prophecy_figure_skill');
        $this->addSql('DROP INDEX IDX_551667BB5585C142 ON prophecy_figure_skill');
        $this->addSql('ALTER TABLE prophecy_figure_skill ADD figure VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD skill VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP figure_id, DROP skill_id');
