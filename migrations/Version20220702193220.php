 ...
 */
final class Version20220702193220 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure ADD disadvantages_comment VARCHAR(255) DEFAULT NULL');
    }
