 ...
 */
final class Version20220408171338 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prophecy_carrier (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, caste VARCHAR(255) NOT NULL, prohibited VARCHAR(255) NOT NULL, campaign VARCHAR(255) NOT NULL, min_status INT NOT NULL, technic VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE test (id INT AUTO_INCREMENT NOT NULL, bla INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
