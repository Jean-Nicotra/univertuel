 ...
 */
final class Version20220613204338 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_modifier_by_age ADD campaign_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE prophecy_modifier_by_age ADD CONSTRAINT FK_2B6E4BF6F639F774 FOREIGN KEY (campaign_id) REFERENCES campaign (id)');
        $this->addSql('CREATE INDEX IDX_2B6E4BF6F639F774 ON prophecy_modifier_by_age (campaign_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_modifier_by_age DROP FOREIGN KEY FK_2B6E4BF6F639F774');
        $this->addSql('DROP INDEX IDX_2B6E4BF6F639F774 ON prophecy_modifier_by_age');
        $this->addSql('ALTER TABLE prophecy_modifier_by_age DROP campaign_id');
