 ...
 */
final class Version20220601184501 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure ADD image VARCHAR(120) DEFAULT NULL');
    }
