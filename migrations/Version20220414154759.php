 ...
 */
final class Version20220414154759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_wound ADD campaign_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE prophecy_wound ADD CONSTRAINT FK_803C3873F639F774 FOREIGN KEY (campaign_id) REFERENCES campaign (id)');
        $this->addSql('CREATE INDEX IDX_803C3873F639F774 ON prophecy_wound (campaign_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_803C3873F639F774 ON prophecy_wound');
        $this->addSql('ALTER TABLE prophecy_wound DROP campaign_id, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE damages damages VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
