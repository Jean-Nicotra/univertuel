 ...
 */
final class Version20220413133826 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_caracteristic ADD campaign_id INT DEFAULT NULL, ADD name VARCHAR(255) NOT NULL, ADD code VARCHAR(3) NOT NULL, ADD min_value INT NOT NULL, ADD maximum_value INT NOT NULL, ADD xp_increase INT NOT NULL, ADD description LONGTEXT NOT NULL, DROP figure_id, DROP caracteristic_id, DROP value');
        ...
        $this->addSql('CREATE INDEX IDX_565B83D2F639F774 ON prophecy_caracteristic (campaign_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_565B83D2F639F774 ON prophecy_caracteristic');
        $this->addSql('ALTER TABLE prophecy_caracteristic ADD figure_id INT NOT NULL, ADD caracteristic_id INT NOT NULL, ADD value INT NOT NULL, DROP campaign_id, DROP name, DROP code, DROP min_value, DROP maximum_value, DROP xp_increase, DROP description');
