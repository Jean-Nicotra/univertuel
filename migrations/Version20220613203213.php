 ...
 */
final class Version20220613203213 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prophecy_modifier_by_age (id INT AUTO_INCREMENT NOT NULL, age_id INT NOT NULL, caracteristic_id INT NOT NULL, value INT NOT NULL, INDEX IDX_2B6E4BF6CC80CD12 (age_id), INDEX IDX_2B6E4BF681194CF4 (caracteristic_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE prophecy_modifier_by_age ADD CONSTRAINT FK_2B6E4BF6CC80CD12 FOREIGN KEY (age_id) REFERENCES prophecy_age (id)');
        $this->addSql('ALTER TABLE prophecy_modifier_by_age ADD CONSTRAINT FK_2B6E4BF681194CF4 FOREIGN KEY (caracteristic_id) REFERENCES prophecy_caracteristic (id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE prophecy_modifier_by_age');
