 ...
 */
final class Version20220825145045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prophecy_figure_weapon (id INT AUTO_INCREMENT NOT NULL, figure_id INT NOT NULL, weapon_id INT NOT NULL, quantity INT NOT NULL, comment VARCHAR(255) DEFAULT NULL, INDEX IDX_FBEA02FE5C011B5 (figure_id), INDEX IDX_FBEA02FE95B82273 (weapon_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE prophecy_figure_weapon ADD CONSTRAINT FK_FBEA02FE5C011B5 FOREIGN KEY (figure_id) REFERENCES prophecy_figure (id)');
        $this->addSql('ALTER TABLE prophecy_figure_weapon ADD CONSTRAINT FK_FBEA02FE95B82273 FOREIGN KEY (weapon_id) REFERENCES prophecy_figure (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prophecy_figure_weapons (id INT AUTO_INCREMENT NOT NULL, figure_id INT NOT NULL, weapon_id INT NOT NULL, quantity INT NOT NULL, comment VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, INDEX IDX_41F0FA125C011B5 (figure_id), INDEX IDX_41F0FA1295B82273 (weapon_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE prophecy_figure_weapons ADD CONSTRAINT FK_41F0FA125C011B5 FOREIGN KEY (figure_id) REFERENCES prophecy_figure (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE prophecy_figure_weapons ADD CONSTRAINT FK_41F0FA1295B82273 FOREIGN KEY (weapon_id) REFERENCES prophecy_figure (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('DROP TABLE prophecy_figure_weapon');
