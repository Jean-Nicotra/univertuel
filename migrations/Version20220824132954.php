 ...
 */
final class Version20220824132954 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prophecy_figures_spells (figure_id INT NOT NULL, spell_id INT NOT NULL, INDEX IDX_CCC3DE32479EC90D (spell_id), INDEX IDX_CCC3DE325C011B5 (figure_id), PRIMARY KEY(figure_id, spell_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE prophecy_figures_spells ADD CONSTRAINT FK_CCC3DE32479EC90D FOREIGN KEY (spell_id) REFERENCES prophecy_spell (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE prophecy_figures_spells ADD CONSTRAINT FK_CCC3DE325C011B5 FOREIGN KEY (figure_id) REFERENCES prophecy_figure (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
