 ...
 */
final class Version20220825155418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_shield ADD CONSTRAINT FK_8C4A77F01BB82155 FOREIGN KEY (shield_id) REFERENCES prophecy_shield (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_shield ADD CONSTRAINT FK_8C4A77F01BB82155 FOREIGN KEY (shield_id) REFERENCES prophecy_armor (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
