 ...
 */
final class Version20220413095448 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_xpincrease CHANGE campaign_id campaign_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_xpincrease CHANGE campaign_id campaign_id INT NOT NULL');
