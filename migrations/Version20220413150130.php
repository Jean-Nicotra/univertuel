 ...
 */
final class Version20220413150130 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure ADD caracteristics_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE prophecy_figure ADD CONSTRAINT FK_976724285D20926C FOREIGN KEY (caracteristics_id) REFERENCES prophecy_figure_caracteristic (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure DROP caracteristics_id, CHANGE name name VARCHAR(120) NOT NULL COLLATE `utf8mb4_unicode_ci`');
