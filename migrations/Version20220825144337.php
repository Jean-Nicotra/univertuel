 ...
 */
final class Version20220825144337 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prophecy_figure_weapons (id INT AUTO_INCREMENT NOT NULL, figure_id INT NOT NULL, weapon_id INT NOT NULL, quantity INT NOT NULL, comment VARCHAR(255) DEFAULT NULL, INDEX IDX_41F0FA125C011B5 (figure_id), INDEX IDX_41F0FA1295B82273 (weapon_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE prophecy_figure_weapons ADD CONSTRAINT FK_41F0FA125C011B5 FOREIGN KEY (figure_id) REFERENCES prophecy_figure (id)');
        $this->addSql('ALTER TABLE prophecy_figure_weapons ADD CONSTRAINT FK_41F0FA1295B82273 FOREIGN KEY (weapon_id) REFERENCES prophecy_figure (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prophecy_figures_armors (figure_id INT NOT NULL, armor_id INT NOT NULL, INDEX IDX_EBAE87AB5C011B5 (figure_id), INDEX IDX_EBAE87ABF5AA3663 (armor_id), PRIMARY KEY(figure_id, armor_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE prophecy_figures_weapons (figure_id INT NOT NULL, weapon_id INT NOT NULL, INDEX IDX_662476CC5C011B5 (figure_id), INDEX IDX_662476CC95B82273 (weapon_id), PRIMARY KEY(figure_id, weapon_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE prophecy_figures_armors ADD CONSTRAINT FK_EBAE87AB5C011B5 FOREIGN KEY (figure_id) REFERENCES prophecy_figure (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE prophecy_figures_armors ADD CONSTRAINT FK_EBAE87ABF5AA3663 FOREIGN KEY (armor_id) REFERENCES prophecy_armor (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE prophecy_figures_weapons ADD CONSTRAINT FK_662476CC5C011B5 FOREIGN KEY (figure_id) REFERENCES prophecy_figure (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE prophecy_figures_weapons ADD CONSTRAINT FK_662476CC95B82273 FOREIGN KEY (weapon_id) REFERENCES prophecy_weapon (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('DROP TABLE prophecy_figure_weapons');
