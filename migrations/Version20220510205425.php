 ...
 */
final class Version20220510205425 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_omen ADD campaign_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE prophecy_omen ADD CONSTRAINT FK_8ADE7198F639F774 FOREIGN KEY (campaign_id) REFERENCES campaign (id)');
        $this->addSql('CREATE INDEX IDX_8ADE7198F639F774 ON prophecy_omen (campaign_id)');
    }
