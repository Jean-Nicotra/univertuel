 ...
 */
final class Version20220824155423 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prophecy_figure_favour (id INT AUTO_INCREMENT NOT NULL, figure_id INT NOT NULL, favour_id INT NOT NULL, comment VARCHAR(255) DEFAULT NULL, INDEX IDX_B87858FF5C011B5 (figure_id), INDEX IDX_B87858FFCA2F0FB1 (favour_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE prophecy_figure_favour ADD CONSTRAINT FK_B87858FF5C011B5 FOREIGN KEY (figure_id) REFERENCES prophecy_figure (id)');
        $this->addSql('ALTER TABLE prophecy_figure_favour ADD CONSTRAINT FK_B87858FFCA2F0FB1 FOREIGN KEY (favour_id) REFERENCES prophecy_discipline (id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE prophecy_figure_favour');
