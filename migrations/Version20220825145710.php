 ...
 */
final class Version20220825145710 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_weapon DROP FOREIGN KEY FK_FBEA02FE95B82273');
        $this->addSql('ALTER TABLE prophecy_figure_weapon ADD CONSTRAINT FK_FBEA02FE95B82273 FOREIGN KEY (weapon_id) REFERENCES prophecy_weapon (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_weapon ADD CONSTRAINT FK_FBEA02FE95B82273 FOREIGN KEY (weapon_id) REFERENCES prophecy_figure (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
