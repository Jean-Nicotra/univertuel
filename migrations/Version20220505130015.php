 ...
 */
final class Version20220505130015 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE prophecy_campaign_caste');
        $this->addSql('ALTER TABLE prophecy_advantage ADD campaign_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_5E6FF7B6F639F774 ON prophecy_advantage (campaign_id)');
        $this->addSql('ALTER TABLE prophecy_carrier ADD campaign_id INT DEFAULT NULL, DROP campaign');
        ...
        $this->addSql('CREATE INDEX IDX_C2E4F153F639F774 ON prophecy_carrier (campaign_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE prophecy_campaign_caste (id INT AUTO_INCREMENT NOT NULL, creation_available TINYINT(1) NOT NULL, display TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('DROP INDEX IDX_5E6FF7B6F639F774 ON prophecy_advantage');
        $this->addSql('ALTER TABLE prophecy_advantage DROP campaign_id, CHANGE name name VARCHAR(120) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
