 ...
 */
final class Version20221026143216 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_wound CHANGE wounds_id wounds_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE prophecy_wounds CHANGE wound_id wound_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_wound CHANGE wounds_id wounds_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE prophecy_wounds CHANGE wound_id wound_id INT DEFAULT NULL');
