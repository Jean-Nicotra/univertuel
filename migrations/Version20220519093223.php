 ...
 */
final class Version20220519093223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure ADD advantage_points INT DEFAULT NULL');
    }
