 ...
 */
final class Version20221025094712 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_wound DROP damages, DROP max_wounds');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_wound ADD damages VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, ADD max_wounds INT NOT NULL, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
