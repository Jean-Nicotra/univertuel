 ...
 */
final class Version20220613194648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure ADD free_points INT DEFAULT NULL');
        $this->addSql('ALTER TABLE prophecy_figure_tendency DROP free_points');
    }
