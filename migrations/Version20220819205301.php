 ...
 */
final class Version20220819205301 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_initial_currencies ADD campaign_id INT NOT NULL');
        $this->addSql('ALTER TABLE prophecy_initial_currencies ADD CONSTRAINT FK_7A95193BF639F774 FOREIGN KEY (campaign_id) REFERENCES campaign (id)');
        $this->addSql('CREATE INDEX IDX_7A95193BF639F774 ON prophecy_initial_currencies (campaign_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_initial_currencies DROP FOREIGN KEY FK_7A95193BF639F774');
        $this->addSql('DROP INDEX IDX_7A95193BF639F774 ON prophecy_initial_currencies');
        $this->addSql('ALTER TABLE prophecy_initial_currencies DROP campaign_id');
