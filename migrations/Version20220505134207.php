 ...
 */
final class Version20220505134207 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE figure ADD owner_id INT NOT NULL, CHANGE campaign campaign_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_2F57B37AF639F774 ON figure (campaign_id)');
        $this->addSql('CREATE INDEX IDX_2F57B37A7E3C61F9 ON figure (owner_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_2F57B37AF639F774 ON figure');
        $this->addSql('DROP INDEX IDX_2F57B37A7E3C61F9 ON figure');
        $this->addSql('ALTER TABLE figure ADD campaign INT NOT NULL, DROP campaign_id, DROP owner_id');
