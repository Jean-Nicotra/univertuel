 ...
 */
final class Version20220420202149 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE figures_armors (figure_id INT NOT NULL, armor_id INT NOT NULL, INDEX IDX_F20F7FDA5C011B5 (figure_id), INDEX IDX_F20F7FDAF5AA3663 (armor_id), PRIMARY KEY(figure_id, armor_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE figures_spells (figure_id INT NOT NULL, spell_id INT NOT NULL, INDEX IDX_D56226435C011B5 (figure_id), INDEX IDX_D5622643479EC90D (spell_id), PRIMARY KEY(figure_id, spell_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE figures_armors ADD CONSTRAINT FK_F20F7FDA5C011B5 FOREIGN KEY (figure_id) REFERENCES prophecy_figure (id)');
        $this->addSql('ALTER TABLE figures_armors ADD CONSTRAINT FK_F20F7FDAF5AA3663 FOREIGN KEY (armor_id) REFERENCES prophecy_armor (id)');
        $this->addSql('ALTER TABLE figures_spells ADD CONSTRAINT FK_D56226435C011B5 FOREIGN KEY (figure_id) REFERENCES prophecy_figure (id)');
        $this->addSql('ALTER TABLE figures_spells ADD CONSTRAINT FK_D5622643479EC90D FOREIGN KEY (spell_id) REFERENCES prophecy_spell (id)');
    }
