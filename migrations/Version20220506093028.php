 ...
 */
final class Version20220506093028 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure CHANGE caste_id caste_id INT DEFAULT NULL');
    }
