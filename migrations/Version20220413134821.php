 ...
 */
final class Version20220413134821 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE prophecy_figure_caracteristic (id INT AUTO_INCREMENT NOT NULL, figure_id INT NOT NULL, caracteristic_id INT DEFAULT NULL, value INT NOT NULL, INDEX IDX_15D9E5B75C011B5 (figure_id), INDEX IDX_15D9E5B781194CF4 (caracteristic_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
