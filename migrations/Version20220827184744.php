 ...
 */
final class Version20220827184744 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE log ADD figure_id INT NOT NULL, ADD campaign_id INT NOT NULL, ADD category_id INT DEFAULT NULL, DROP figure, DROP campaign, DROP category');
        $this->addSql('ALTER TABLE log ADD CONSTRAINT FK_8F3F68C55C011B5 FOREIGN KEY (figure_id) REFERENCES figure (id)');
        $this->addSql('ALTER TABLE log ADD CONSTRAINT FK_8F3F68C5F639F774 FOREIGN KEY (campaign_id) REFERENCES campaign (id)');
        $this->addSql('ALTER TABLE log ADD CONSTRAINT FK_8F3F68C512469DE2 FOREIGN KEY (category_id) REFERENCES log_category (id)');
        $this->addSql('CREATE INDEX IDX_8F3F68C55C011B5 ON log (figure_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE log DROP FOREIGN KEY FK_8F3F68C55C011B5');
        $this->addSql('ALTER TABLE log DROP FOREIGN KEY FK_8F3F68C5F639F774');
        $this->addSql('ALTER TABLE log DROP FOREIGN KEY FK_8F3F68C512469DE2');
        $this->addSql('DROP INDEX IDX_8F3F68C55C011B5 ON log');
        $this->addSql('DROP INDEX IDX_8F3F68C5F639F774 ON log');
        $this->addSql('DROP INDEX IDX_8F3F68C512469DE2 ON log');
        $this->addSql('ALTER TABLE log ADD figure INT NOT NULL, ADD campaign INT NOT NULL, ADD category INT NOT NULL, DROP figure_id, DROP campaign_id, DROP category_id, CHANGE description description LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
