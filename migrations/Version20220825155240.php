 ...
 */
final class Version20220825155240 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_shield DROP FOREIGN KEY FK_8C4A77F0F5AA3663');
        $this->addSql('DROP INDEX IDX_8C4A77F0F5AA3663 ON prophecy_figure_shield');
        $this->addSql('ALTER TABLE prophecy_figure_shield CHANGE armor_id shield_id INT NOT NULL');
        $this->addSql('ALTER TABLE prophecy_figure_shield ADD CONSTRAINT FK_8C4A77F01BB82155 FOREIGN KEY (shield_id) REFERENCES prophecy_armor (id)');
        $this->addSql('CREATE INDEX IDX_8C4A77F01BB82155 ON prophecy_figure_shield (shield_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_shield DROP FOREIGN KEY FK_8C4A77F01BB82155');
        $this->addSql('DROP INDEX IDX_8C4A77F01BB82155 ON prophecy_figure_shield');
        $this->addSql('ALTER TABLE prophecy_figure_shield CHANGE comment comment VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE shield_id armor_id INT NOT NULL');
        $this->addSql('ALTER TABLE prophecy_figure_shield ADD CONSTRAINT FK_8C4A77F0F5AA3663 FOREIGN KEY (armor_id) REFERENCES prophecy_armor (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE INDEX IDX_8C4A77F0F5AA3663 ON prophecy_figure_shield (armor_id)');
