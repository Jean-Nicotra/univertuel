 ...
 */
final class Version20220524200043 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE relations (user_id INT NOT NULL, relation_user_id INT NOT NULL, INDEX IDX_146CBF78A76ED395 (user_id), INDEX IDX_146CBF78BE15C1E4 (relation_user_id), PRIMARY KEY(user_id, relation_user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE relations ADD CONSTRAINT FK_146CBF78A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE relations ADD CONSTRAINT FK_146CBF78BE15C1E4 FOREIGN KEY (relation_user_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
