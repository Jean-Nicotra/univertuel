 ...
 */
final class Version20221013203003 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_tendency_age_nation ADD campaign_id INT NOT NULL');
        $this->addSql('ALTER TABLE prophecy_tendency_age_nation ADD CONSTRAINT FK_B2BEB61CF639F774 FOREIGN KEY (campaign_id) REFERENCES campaign (id)');
        $this->addSql('CREATE INDEX IDX_B2BEB61CF639F774 ON prophecy_tendency_age_nation (campaign_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_tendency_age_nation DROP FOREIGN KEY FK_B2BEB61CF639F774');
        $this->addSql('DROP INDEX IDX_B2BEB61CF639F774 ON prophecy_tendency_age_nation');
        $this->addSql('ALTER TABLE prophecy_tendency_age_nation DROP campaign_id');
