 ...
 */
final class Version20220510210808 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_skill_category ADD campaign_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_5D458C42F639F774 ON prophecy_skill_category (campaign_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_5D458C42F639F774 ON prophecy_skill_category');
        $this->addSql('ALTER TABLE prophecy_skill_category DROP campaign_id, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
