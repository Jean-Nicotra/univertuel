 ...
 */
final class Version20220619085017 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure ADD is_minor_attributes_choosen TINYINT(1) NOT NULL');
    }
