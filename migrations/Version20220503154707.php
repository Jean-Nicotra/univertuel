 ...
 */
final class Version20220503154707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prophecy_figure_major_attribute DROP FOREIGN KEY FK_7F3920ABB6E62EFA');
        $this->addSql('DROP INDEX IDX_7F3920ABB6E62EFA ON prophecy_figure_major_attribute');
        $this->addSql('ALTER TABLE prophecy_figure_major_attribute CHANGE attribute_id major_attribute_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_7F3920ABB4B49857 ON prophecy_figure_major_attribute (major_attribute_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_7F3920ABB4B49857 ON prophecy_figure_major_attribute');
        $this->addSql('ALTER TABLE prophecy_figure_major_attribute CHANGE major_attribute_id attribute_id INT NOT NULL');
        $this->addSql('ALTER TABLE prophecy_figure_major_attribute ADD CONSTRAINT FK_7F3920ABB6E62EFA FOREIGN KEY (attribute_id) REFERENCES prophecy_major_attribute (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE INDEX IDX_7F3920ABB6E62EFA ON prophecy_figure_major_attribute (attribute_id)');
